			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Change Package Image</h2>
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<form method="post" class="form-horizontal" enctype="multipart/form-data">
											...
											<label class="col-sm-4 control-label">Package Image Now</label>
												<?php 
											...
											<label class="col-sm-4 control-label">Upload a New Package Image<span style="color:red">*</span></label>
												<div class="col-sm-4">
