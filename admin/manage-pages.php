						...
						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Manage Pages Form</div>
									<div class="panel-body">
										...
										<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<select name="menu1" class="form-control" onChange="MM_jumpMenu('parent',this,0)">
													  ...
													  <option value="manage-pages.php?type=rekening">Bank Account</option>
													</select>
												</div>
											</div>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Selected Pages</label>
												<div class="col-sm-4">
												<?php
												switch($_GET['type'])
												{
