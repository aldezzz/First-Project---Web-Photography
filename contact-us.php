...
if($lastInsertId){
	$msg="Message sent. We will contact you as soon as possible .";
}else{
...
<section class="contact_us section-padding">
  <div class="container">
    <div  class="row">
      <div class="col-md-6">
        <h3>C. A. H Photography</h3>
        <h4>WORKING HOURS:</h4>
          <p>Monday - Sunday : 11.00 AM - 21.00 PM </p>
...
<!-- Mirrored from themes.webmasterdriver.net/carforyou/demo/contact-us.html by HTTrack Website Copier/3.x  -->
</html>
